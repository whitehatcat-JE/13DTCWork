...
public class CartoonCharacter {
    ...
    */
    public void setCanvasWidth(int width) {
        this.canvasWidth = UI.getCanvasWidth();
    }
    ...
    public void walk(double dist) {
        this.erase();
        if (this.direction.equals("right")&&(this.characterX+dist<UI.getCanvasWidth())){
            this.characterX = this.characterX + dist;
        }
        else if (this.direction.equals("left")&&(this.characterX-dist>0)){
            this.characterX = this.characterX - dist;
        }
        this.draw();
    }
